...
let arr = ["You are Beautiful", "I believe in you!", "You are worthy", "Keep going!", "Make it happen.", "I Admire You", "Things will get better", "Follow your heart.", "You are strong!", "Be still.", "You matter.", "You did great today!"]
...
function q1Fn() {
    if (flag) {
        ...
        flag = false;
        q1.setAttribute('src', './icons/up.svg')
        ...
        q1.setAttribute('src', './icons/down.svg')

    }
}
q1.addEventListener('click', q1Fn)
...
function q2Fn() {
    if (flag1) {
        ...
        flag1 = false;
        q2.setAttribute('src', './icons/up.svg')
        ...
        q2.setAttribute('src', './icons/down.svg')

    }

}

q2.addEventListener('click', q2Fn)
let service = true;
